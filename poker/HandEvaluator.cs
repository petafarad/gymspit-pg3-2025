    ...
    public static class HandEvaluator
    {
        public static HandEvaluation Evaluate(List<Card> cards)
        {
            ...
            int? FindStraightHighCard(List<int> distinctRanksDesc)
            {
                ...
                if (ranks.Contains(14) && !ranks.Contains(1)) ranks.Add(1);
                ...
                for (int i = 1; i < ranks.Count; i++)
                {
                    ...
                    if (run >= 5)
                    {
                        bestHigh = Math.Max(bestHigh, ranks[i - 4] == 1 ? 5 : ranks[i - 4 + 0]);
                    }
                }
                ...
                if (ranks.Count >= 5)
                {
                    for (int start = 0; start <= ranks.Count - 5; start++)
                    {
                        ...
                        if (ok)
                        {
                            ...
                            if (high == 14 && ranks[start + 4] == 1) high = 5;
